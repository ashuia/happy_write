**地标魔都，已入职python爬虫工程师，用linux操作着vim写python程序，手感非常棒，本人热爱自己的工作，不考虑换工作！！！喜欢骑行游上海更喜欢结交朋友，想交朋友的可以通过邮箱或者微博联系我，qq、wechat什么的欢迎社工我[斜眼笑]**

以下为求职时用的在线简历，简陋的低级开发仅供参考交流，如有技术交流请看上一段文字！
...
> 5.如有雷同，纯属失散多年兄弟，快加我[坏笑]

# 　　陈滔  

| **期望薪资** | 面议 | **应聘岗位** | web前端（着重javascript） | **微博** | [QR_code](./photo/webo_qr.png) |
| :---: | :---: | :---: | :---: | :---: | :---: |
| **Tel** | 1785586**** | **E-mail** | chinaitlearner@gmail.com | **籍贯** | 江西 |
...
:clock3: 2017.2 - 至今 :clock930:　　　　**（公司保密）　　　　`python`爬虫工程师  
　　:+1:数据爬取，数据分析，云+运维。
...
还有搭建 github + hexo 博客就不写了，个人玩乐，技术含量低。
